...
const contentCreationLockFailedMessage = '요청 처리 중 오류가 발생했습니다. 새로고침 후 다시 시도해 주세요.'
const contentCreationCleanupRequiredMessage = '브라우저의 임시 요청 기록을 삭제하지 못해 같은 요청을 다시 보내지 않았습니다. 브라우저 저장을 허용한 뒤 임시 요청 기록 삭제를 다시 시도해 주세요.'
const contentCreationCleanupCompletedMessage = '브라우저의 임시 요청 기록을 삭제했습니다. 목록과 입력을 확인한 뒤 다시 제출해 주세요.'
