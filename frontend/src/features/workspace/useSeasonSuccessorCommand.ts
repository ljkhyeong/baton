...
const lockFailedMessage = '다음 시즌 시작 중 오류가 발생했습니다. 새로고침 후 다시 시도해 주세요.'
const cleanupRequiredMessage = '브라우저의 임시 요청 기록을 삭제하지 못했습니다. 브라우저 저장을 허용한 뒤 임시 요청 기록 삭제를 다시 시도해 주세요.'
