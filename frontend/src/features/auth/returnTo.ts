...
type AccountAuthReturnTo = '/account' | '/join' | '/my-teams'
...
export function safeAuthReturnTo(
  ...
  if (['/account', '/join', '/my-teams'].includes(parsed.pathname)) return parsed.search ? null : parsed.pathname as AuthReturnTo
