...
export interface paths {
    ...
    "/api/v1/auth/account": {
        ...
        /**
         * 계정 보안 정보 조회
         * @description 현재 로그인 계정의 표시 이름과 연결된 로그인 방법을 조회한다. 공급자가 이메일을 제공하지 않으면 email은 null이다.
         */
    ...
    "/api/v1/teams/{teamId}/seasons/{seasonId}/brief/attention-items/transitions": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/teams/{teamId}/seasons/{seasonId}/notifications": {
        ...
        /**
         * 내 알림함 조회
         * @description 현재 내 역할의 마감 임박·지연 업무와 수락할 인수인계를 반환한다.
         */
    ...
    "/api/v1/teams/{teamId}/seasons/{seasonId}/role-resources/{resourceId}/check-requests": {
        ...
        /**
         * 자료 재점검 접수
         * @description 팀 변경 권한과 자료 소유권을 확인한 뒤 비동기 URL 재점검을 접수한다. 완료 결과가 아니다.
         */
    ...
    "/api/v1/teams/{teamId}/seasons/{seasonId}/role-resources/{resourceId}/health": {
        ...
        /**
         * 자료 연결 상태 조회
         * @description 팀 읽기 권한과 자료 소유권을 확인한 뒤 자료 화면과 별도로 현재 연결 상태를 조회한다.
         */
    ...
    "/api/v1/teams/{teamId}/seasons/{seasonId}/roles/{roleId}/handoffs/{handoffId}/cancellation": {
        ...
        /**
         * 역할 인수인계 취소
         * @description 수락 전 역할 인수인계를 취소하고 역할의 다음 담당자 예약을 되돌린다.
         */
    ...
    "/api/v1/teams/{teamId}/seasons/{seasonId}/roles/{roleId}/handoffs/{handoffId}/transfer": {
        ...
        /**
         * 역할 인수인계 전달
         * @description 이전 담당자 명의의 확인과 준비도 경고 확인을 기록해 인수인계를 수락 대기로 전환한다.
         */
    ...
    "/api/v1/teams/{teamId}/seasons/{seasonId}/rounds": {
        ...
        /**
         * 시즌 회차 생성
         * @description 시즌에 수동 회차를 만들고 현재 반복 업무 정의를 실행 항목으로 복제한다.
         */
    ...
    "/api/v1/teams/{teamId}/seasons/{seasonId}/rounds/{roundId}/archive": {
        ...
        /**
         * 시즌 회차 보관 상태 변경
         * @description 회차와 반복 업무 실행 기록을 지우지 않고 활성 목록에서 보관하거나 다시 복원한다.
         */
    ...
    "/api/v1/teams/{teamId}/seasons/{seasonId}/rounds/{roundId}/routine-executions/{executionId}/completion": {
         ...
         * @description 특정 회차의 반복 업무 실행 완료 여부를 WAITING 또는 DONE 상태로 변경한다.
         */
    ...
    "/api/v1/teams/{teamId}/seasons/{seasonId}/routines": {
        ...
        /**
         * 반복 업무 생성
         * @description 현재 시즌에 반복해서 실행할 팀 반복 업무 정의를 등록한다.
         */
    ...
    "/api/v1/teams/{teamId}/seasons/{seasonId}/routines/{routineId}": {
        ...
        /**
         * 반복 업무 수정
         * @description 현재 시즌의 팀 반복 업무 정의를 수정한다.
         */
    ...
    "/api/v1/teams/{teamId}/seasons/{seasonId}/routines/{routineId}/archive": {
        ...
        /**
         * 반복 업무 보관 상태 변경
         * @description 반복 업무 정의를 활성 목록에서 보관하거나 다시 복원한다.
         */
    ...
    "/api/v1/teams/{teamId}/seasons/{seasonId}/workspace": {
        ...
        /**
         * 워크스페이스 조회
         * @description 오늘 화면에 필요한 팀, 시즌, 역할, 역할 자료, 반복 업무 정의, 회차별 실행, 결정과 인수인계 프로젝션을 조회한다.
         */
    ...
    "/round/rooms/{roomId}/participation-grant/refresh": {
        ...
        /**
         * ROUND 참여권 갱신
         * @description 현재 계정 멤버십과 서버에서 관리하는 방 매핑을 확인하고 방 경로에 한정된 참여권 쿠키를 회전한다. 위치 힌트 본문은 선택 사항이다.
         */
    ...
    schemas: {
        ...
        Schema_0a33700254652cb2: {
            ...
            copiedRoutines: {
                /**
                 * Format: uuid
                 * @description 새 반복 업무 UUID
                 */
                routineId: string;
                /**
                 * Format: uuid
                 * @description 원본 반복 업무 UUID
                 */
        ...
        Schema_a55bef4846f0ff82: {
            ...
            notifications: {
                ...
                /**
                 * Format: uuid
                 * @description 관련 회차 식별자, 인수인계는 null
                 */
                roundId: string | null;
                /**
                 * Format: uuid
                 * @description 반복 업무 실행 또는 역할 인수인계 식별자
                 */
                sourceId: string;
...
export interface operations {
    ...
    getAccountSecurity: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Schema_f8f286f6a4bb5ab7"];
                };
            };
        };
    };
    ...
    getNotificationPreferences: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Schema_0b69cfbed0f085a4"];
                };
            };
        };
    };
    configureNotificationPreferences: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Schema_e654ecd4cfb8accd"];
            };
        };
        responses: {
            /** @description 200 */
    ...
    getBriefAttentionItems: {
        parameters: {
            ...
            header?: {
                /**
                 * @description 공유 키 방식의 팀에서 사용하는 접근 키
                 * @example access-key
                 */
                "X-Baton-Access-Key"?: string;
            };
    ...
    getWorkspaceNotifications: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Schema_a55bef4846f0ff82"];
                };
            };
        };
    };
    ...
    requestResourceCheck: {
        parameters: {
            ...
            header?: {
                /**
                 * @description 공유 키 팀의 접근 키. 계정 권한 팀은 로그인 세션을 사용한다.
                 * @example workspace-access-key
                 */
                "X-Baton-Access-Key"?: string;
            };
    ...
    updateRoutineExecutionCompletion: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Schema_a74a5eb6e1727c5b"];
                };
            };
            /** @description 404 */
            404: {
    ...
    createRoutine: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Schema_2749ed0aebe2038f"];
            };
        };
        responses: {
            /** @description 201 */
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["Schema_864038dbb358c10b"];
                };
            };
            /** @description 400 */
            400: {
    ...
    createNextSeason: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Schema_7384160ed9534c5f"];
            };
        };
        responses: {
            /** @description 201 */
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["Schema_0a33700254652cb2"];
                };
            };
            /** @description 400 */
            400: {
