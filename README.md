...
- `역할`: 현재 팀의 구성원 추가·이름 정정·활동 종료·재활성화, 로그인 계정과 기존 구성원 연결, 현재 시즌 역할의 목적, 책임, 현재·다음 담당자와 담당 기간 등록·수정, 참고 자료 링크 연결과 이전 시즌 기록 조회·자료 이어받기
...
- `인수인계`: 역할별 인수인계 항목 등록·수정·완료와 보관·복원, 완료 항목·역할 책임·주의사항을 포함한 인수인계 문서 미리보기와 인쇄·PDF 저장, 다음 담당 기간을 정한 인수인계 준비·전달·수락·취소
