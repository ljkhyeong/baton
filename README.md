...
자료에는 ‘사용 가능·수정 필요’ 확인 결과와 재확인 주기를 기록할 수 있다. 내 알림은 마감 임박·업무 지연·수락할 인수인계를 표시하며, 읽음과 알림 설정을 계정별로 저장한다. 결정·자료·체크리스트 본문 초안은 같은 브라우저 탭에서 복구할 수 있다.
...
| WATCH | 자료 URL 점검과 상태 변경 전달 | BATON의 송신 아웃박스·수신 인박스 구현. 공개 HTTPS 전달 검증과 점검 상태 화면은 남아 있다. [계약](docs/PRD/0004_watch-integration-contract/spec.md) |
