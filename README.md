...
역할 상세의 활성 자료에는 WATCH 연결 상태, 최근 점검 시각과 다시 점검 버튼을 표시한다.
자료 조회와 별도 요청을 사용하며 WATCH 장애·누락·5분 이상 오래된 점검은 자료 링크를 유지한 채
...
다시 요청할 수 있는 시간까지 남은 초를 표시하며, 새 점검 결과를 확인하면 접수 안내를 바꾼다.
