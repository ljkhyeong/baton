...
public class WorkspaceService implements WorkspaceUseCase {
    ...
    private final WorkspaceRoleLifecycle roleLifecycle;
    private final WorkspaceRoutineRoundLifecycle routineRoundLifecycle;
    ...
    public WorkspaceService(
        ...
        this.memberReferenceValidator = new WorkspaceMemberReferenceValidator(repository);
        this.roleReferenceValidator = new WorkspaceRoleReferenceValidator(repository);
        ...
        this.roleLifecycle = new WorkspaceRoleLifecycle(
                repository,
                clock,
                resultMapper,
                contentIdempotency,
                memberReferenceValidator
        );
        this.routineRoundLifecycle = new WorkspaceRoutineRoundLifecycle(
                repository,
                clock,
                resultMapper,
                contentIdempotency,
    ...
    public RoleResult createRoleAuthorized(
        ...
        requireValidIdempotencyKey(idempotencyKey);
        return roleLifecycle.createRole(
                teamId,
                seasonId,
                new WorkspaceScope(scope.team(), scope.season()),
                idempotencyKey,
    ...
    public RoleResult updateRoleAuthorized(
        ...
        AuthorizedScope scope = authorizeMutation(teamId, seasonId, authorization);
        return roleLifecycle.updateRole(
                teamId,
                seasonId,
                roleId,
                new WorkspaceScope(scope.team(), scope.season()),
    ...
    public RoleHandoffTransitionResult prepareRoleHandoffAuthorized(
        ...
        AuthorizedScope scope = authorizeMutation(teamId, seasonId, authorization);
        requireValidIdempotencyKey(idempotencyKey);
        return roleLifecycle.prepareRoleHandoff(
                teamId,
                seasonId,
                roleId,
                new WorkspaceScope(scope.team(), scope.season()),
    ...
    public RoleHandoffTransitionResult transferRoleHandoffAuthorized(
        ...
        return roleLifecycle.transferRoleHandoff(
                teamId,
                seasonId,
                roleId,
                handoffId,
    ...
    public RoleHandoffTransitionResult acceptRoleHandoffAuthorized(
        ...
        AuthorizedScope scope = authorizeMutation(teamId, seasonId, authorization);
        requireActingMember(scope, command.confirmedByMemberId());
        return roleLifecycle.acceptRoleHandoff(
                teamId,
                seasonId,
                roleId,
                handoffId,
    ...
    public RoleHandoffTransitionResult cancelRoleHandoffAuthorized(
        ...
        AuthorizedScope scope = authorizeMutation(teamId, seasonId, authorization);
        requireActingMember(scope, command.confirmedByMemberId());
        return roleLifecycle.cancelRoleHandoff(
                teamId,
                seasonId,
                roleId,
                handoffId,
    ...
    public RoutineResult createRoutineAuthorized(
        ...
        AuthorizedScope scope = authorizeMutation(teamId, seasonId, authorization);
        requireValidIdempotencyKey(idempotencyKey);
        return routineRoundLifecycle.createRoutine(
                teamId,
                seasonId,
                new WorkspaceScope(scope.team(), scope.season()),
                idempotencyKey,
    ...
    public RoutineResult updateRoutineAuthorized(
        ...
        AuthorizedScope scope = authorizeMutation(teamId, seasonId, authorization);
        return routineRoundLifecycle.updateRoutine(
                teamId,
                seasonId,
                new WorkspaceScope(scope.team(), scope.season()),
                routineId,
    ...
    public SeasonRoundResult createSeasonRoundAuthorized(
        ...
        AuthorizedScope scope = authorizeMutation(teamId, seasonId, authorization);
        requireValidIdempotencyKey(idempotencyKey);
        return routineRoundLifecycle.createSeasonRound(
                teamId,
                seasonId,
                new WorkspaceScope(scope.team(), scope.season()),
                idempotencyKey,
    ...
    public SeasonRoundResult updateSeasonRoundAuthorized(
        ...
        AuthorizedScope scope = authorizeMutation(teamId, seasonId, authorization);
        return routineRoundLifecycle.updateSeasonRound(
                seasonId,
                roundId,
                new WorkspaceScope(scope.team(), scope.season()),
                command
    ...
    public SeasonRoundResult updateSeasonRoundArchiveAuthorized(
        ...
        AuthorizedScope scope = authorizeMutation(teamId, seasonId, authorization);
        return routineRoundLifecycle.updateSeasonRoundArchive(
                seasonId,
                roundId,
                new WorkspaceScope(scope.team(), scope.season()),
                archived
    ...
    public RoutineExecutionResult updateRoutineExecutionCompletionAuthorized(
        ...
        AuthorizedScope scope = authorizeMutation(teamId, seasonId, authorization);
        return routineRoundLifecycle.updateRoutineExecutionCompletion(
                seasonId,
                roundId,
                executionId,
                new WorkspaceScope(scope.team(), scope.season()),
    ...
    public DecisionResult createDecisionAuthorized(
        ...
        Member author = memberReferenceValidator.requireActive(
                teamId,
    ...
    public DecisionResult updateDecisionAuthorized(
        ...
        Member author = Objects.equals(decision.getAuthorMemberId(), command.authorMemberId())
                ...
                : memberReferenceValidator.requireActive(teamId, command.authorMemberId())
    ...
    public HandoffItemResult createHandoffItemAuthorized(
        ...
        if (attempt.replayResourceId() != null) {
            ...
            roleReferenceValidator.requireOwned(teamId, seasonId, existing.getRoleId());
